...
namespace resolver
{
	...
	void apply_desync_side( C_CSPlayer* player, lag_record_t* record, const lag_record_t* previous );
	void update_moving_side( lag_record_t* record, const lag_record_t* previous );
