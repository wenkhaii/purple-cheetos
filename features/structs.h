...
struct player_log_t
{
	...
	// Resolver state classification cache (set by classify_enemy_state each resolve)
	int m_resolver_state = 0;
	// Per-target delay-shot tick counter for the aimbot's 3-tick timeout
	int m_delay_ticks = 0;
