...
public:
	...
	struct palette
	{
		// Interactive element accent — #F7EBED (soft off-white). Used by buttons,
		// sliders, checkboxes, comboboxes, listboxes, tabs, color picker chrome.
		static evo::ren::color main_pink( const int alpha = 255 ) { return { 247, 235, 237, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
		static evo::ren::color main_purple( const int alpha = 255 ) { return { 200, 190, 192, static_cast< int >( g_menu->get_alpha() * alpha ) }; }

		static evo::ren::color border( const int alpha = 255 ) { return { 42, 42, 46, static_cast< int >( g_menu->get_alpha() * alpha ) }; }

		static evo::ren::color black( const int alpha = 255 ) { return { 18, 18, 20, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
		static evo::ren::color dark_blue( const int alpha = 255 ) { return { 16, 16, 18, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
		static evo::ren::color matte_pink( const int alpha = 255 ) { return { 159, 39, 181, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
		static evo::ren::color hot_pink( const int alpha = 255 ) { return { 247, 235, 237, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
		static evo::ren::color bright_blue( const int alpha = 255 ) { return { 50, 51, 255, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
	};

	static evo::ren::color glitch_red( const int alpha = 255 ) { return { 247, 235, 237, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
	static evo::ren::color glitch_blue( const int alpha = 255 ) { return { 180, 180, 185, static_cast< int >( g_menu->get_alpha() * alpha ) }; }

	static evo::ren::color child_main( const int alpha = 255 ) { return { 20, 20, 24, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
	static evo::ren::color child_sub( const int alpha = 255 ) { return { 22, 22, 26, static_cast< int >( g_menu->get_alpha() * alpha ) }; }

	static evo::ren::color control_top( const int alpha = 255 ) { return { 26, 26, 30, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
	static evo::ren::color control_bot( const int alpha = 255 ) { return { 18, 18, 22, static_cast< int >( g_menu->get_alpha() * alpha ) }; }
