...
void menu::init()
{
	...
	auto menu_window = std::make_shared< window >( _w( "wanheda " ), vec2( 800, 650 ), vec2( 100, 100 ), window_style::flags::none, std::vector<std::shared_ptr<tab>>
	...
	{std::make_shared<checkbox>( _w( "Aimbot" ), vars::aim.enabled )->add_control( std::make_shared<key_bind>( vars::aim.enabled, vars::key.aimbot ) ),
		...
		std::make_shared<checkbox>( _w( "Defensive double tap" ), vars::aim.defensive_doubletap ),
